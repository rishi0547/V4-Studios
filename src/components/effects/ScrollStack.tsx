...
const ScrollStack = ({
  ...
  const setupLenis = useCallback(() => {
    // Cast to `any` for legacy option names from the original component —
    // some are no longer in newer Lenis's published types but still work at runtime.
    const baseOptions = {
      duration: 1.2,
    ...
    if (useWindowScroll) {
      const lenis = new Lenis(baseOptions as ConstructorParameters<typeof Lenis>[0]);
